...
combat2:setParameter(COMBAT_PARAM_EFFECT, 33)
combat2:setParameter(COMBAT_PARAM_DISTANCEEFFECT, 40)
combat2:setFormula(COMBAT_FORMULA_LEVELMAGIC, -38.0, 0, -38.5, 0)
...
function onCastSpell(creature, variant)
	...
	combat2:execute(creature, Variant(target:getPosition()))
