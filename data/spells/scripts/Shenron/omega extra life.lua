local config = {
	...
	effect = 265,           -- efeito do reflect insta
	storage = STORAGE_REVIVE,        -- storage do revive
...
function onCastSpell(creature, cid, variant)
	...
	doSendAnimatedText(creature:getPosition(), "Omega extra life!", TEXTCOLOR_PURPLE)
    ...
    if sendSpellbarCooldownAuto then
        sendSpellbarCooldownAuto(creature, "Omega extra life")
    end
    return true
end