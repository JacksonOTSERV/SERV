local config = {
    duration_spell = 30,  -- tempo do buff em segundos
    aura = 1261,            -- looktype (aura do buff)
	healthRegen = 2000   -- health gain por segundo no buff
}
...
function onCastSpell(creature, variant)
    ...
    if sendSpellbarCooldownAuto then
        sendSpellbarCooldownAuto(creature, "Big power up")
    end
    return true
end