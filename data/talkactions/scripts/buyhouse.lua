function onSay(player, words, param)
    ...
    local message = "You have successfully bought this house, be sure to have the money for the rent in the bank."
    
    if player:isPremium() then
        price = math.floor(price / 2)
        message = message .. " 50% of the capped value for being a premium player"
    end
