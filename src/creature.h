...
using AttachedEffMap = std::map<uint16_t, AttachedEffect>;
...
enum slots_t : uint8_t {
	...
	CONST_SLOT_RING = 9,
	CONST_SLOT_AMMO = 10,
	CONST_SLOT_AMULET = 12,
	CONST_SLOT_AMULET2 = 13,
	CONST_SLOT_ANEL = 14,
	CONST_SLOT_ANEL2 = 15,

	CONST_SLOT_FIRST = CONST_SLOT_HEAD,
	CONST_SLOT_LAST = CONST_SLOT_ANEL2,
};
...
class Creature : virtual public Thing
{
	...
	public:
		...
		Player* getPlayerMaster() const { return (master ? master->getPlayer() : nullptr); }
		...
		void insertAttachedEffect(uint16_t effectId);
