...
public:
  ...
  template <class T> static T **getRawUserdata(lua_State *L, int32_t arg) {
...
private:
  ...
  static int luaCreatureSetInstanceIdRaw(lua_State *L);
  ...
  static int luaDoPlayerRemoveTarget(lua_State *L);
  ...
  static int luaPlayerGetHWID(lua_State *L);
  static int luaPlayerSetHWID(lua_State *L);
  ...
  static int luaPlayerSetPzLockTime(lua_State *L);
  ...
  static int luaPlayerGetDirectionalSpellAngle(lua_State *L);
  static int luaPlayerSetDirectionalSpellAngle(lua_State *L);
  ...
  static int luaPlayerIsSpectator(lua_State *L);
  static int luaPlayerGetInGameSpectators(lua_State *L);
  ...
  static int luaPlayerSendReloginWindow(lua_State *L);
  ...
  // Healthbar
  static int luaDoSetHealthBackgroundOutfit(lua_State *L);
  static int luaDoPlayerAddHealthBackground(lua_State *L);
  static int luaDoPlayerRemoveHealthBackground(lua_State *L);

  // Kote elemental
  static int luaDoSetKoteElementalOutfit(lua_State *L);
  static int luaDoPlayerAddKoteElemental(lua_State *L);
  static int luaDoPlayerRemoveKoteElemental(lua_State *L);

  // Manabar
  static int luaDoSetManaBackgroundOutfit(lua_State *L);
  static int luaDoPlayerAddManaBackground(lua_State *L);
  static int luaDoPlayerRemoveManaBackground(lua_State *L);
  ...
  static int luaDoPlayerTargetCreature(lua_State *L);
  ...
  // Combat
  static int32_t luaCombatGetAttackers(lua_State *L);
  ...
  static int luaMonsterTypeChangeOutfit(lua_State *L);
