...
bool Actions::useItem(Player* player, const Position& pos, uint8_t index, Item* item, bool isHotkey)
{
    ...
    if (itemId != 2150 && itemId != 12779 && itemId != 12780 && itemId != 2149 && itemId != 2580 && itemId != 11403 && itemId != 11404 && itemId != 11405 && itemId != 11407 && itemId != 11408 && itemId != 11409 && itemId != 11410 && itemId != 11411 && itemId != 1227 && itemId != 1229 && itemId != 5098 && itemId != 5107 && itemId != 5100 && itemId != 5109 && itemId != 11414) {
...
namespace {
	...
	bool enterMarket(Player* player, Item*, const Position&, Thing*, const Position&, bool)
	{
		if (player->getLevel() < 150) {
			player->sendTextMessage((MessageClasses)25, "Você precisa de nivel 150 para usar o market.");
			return false;
		}

		player->sendMarketEnter(player->getLastDepotId());

		g_scheduler.addEvent(createSchedulerTask(1000, std::bind(&Game::playerBrowseMarket2, &g_game, player->getID())));
		return true;
	}
}
