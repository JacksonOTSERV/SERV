...
//[3500 - 4000]
static constexpr int32_t PSTRG_HEALTHBG_RANGE_START = (PSTRG_RESERVED_RANGE_START + 3500);
static constexpr int32_t PSTRG_HEALTHBG_RANGE_SIZE = 500;

//[4000 - 4500]
static constexpr int32_t PSTRG_MANABG_RANGE_START = (PSTRG_RESERVED_RANGE_START + 4000);
static constexpr int32_t PSTRG_MANABG_RANGE_SIZE = 500;

//[4500 - 5000]
static constexpr int32_t PSTRG_KOTEBG_RANGE_START = (PSTRG_RESERVED_RANGE_START + 4500);
static constexpr int32_t PSTRG_KOTEBG_RANGE_SIZE = 500;
