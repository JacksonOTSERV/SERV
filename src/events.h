...
class Events
{
	struct EventsInfo {
		...
		int32_t partyOnpassPartyLeadership = -1;
	...
	public:
		...
		bool eventPartyOnpassPartyLeadership(Party* party, Player* player);
		...
		bool eventPlayerOnUseItem(Player* player, Item* item, const Position& fromPosition, Thing* target, const Position& toPosition, bool isHotkey);
