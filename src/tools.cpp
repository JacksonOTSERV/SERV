...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_CONTAINERNOTENOUGHROOM:
			return "Voc� n�o pode colocar mais objetos neste container.";
		...
		case RETURNVALUE_CANNOTTHROW:
			return "Voc� n�o pode jogar isso.";
		...
		case RETURNVALUE_NOTREQUIREDLEVELTOUSERUNE:
			return "Voc� n�o tem o magic level necess�rio para usar esta runa.";
		...
		case RETURNVALUE_YOUMAYNOTLOGOUTDURINGAFIGHT:
			return "Voc� n�o pode sair durante ou imediatamente ap�s a luta!";
		...
		case RETURNVALUE_YOUMAYNOTATTACKTHISPLAYER:
			return "Voc� n�o pode atacar esse jogador.";
		...
		case RETURNVALUE_YOUCANONLYUSEITONCREATURES:
			return "Voc� s� pode usar isso em criaturas.";
		...
		case RETURNVALUE_YOUNEEDAWEAPONTOUSETHISSPELL:
			return "Voc� precisa equipar uma arma para usar este feiti�o.";
		...
		case RETURNVALUE_ACTIONNOTPERMITTEDINANOPVPZONE:
			return "Esta a��o n�o � permitida em uma zona non-PvP.";
		...
		case RETURNVALUE_NOPARTYMEMBERSINRANGE:
			return "Nenhum membro do grupo est� dentro do alcance.";
		...
		case RETURNVALUE_TRADEPLAYERFARAWAY:
			return "O jogador com quem deseja negociar est� muito longe.";

		case RETURNVALUE_YOUDONTOWNTHISHOUSE:
			return "Voc� n�o � o dono desta casa.";

		case RETURNVALUE_TRADEPLAYERALREADYOWNSAHOUSE:
			return "O jogador com quem deseja negociar j� possui uma casa.";

		case RETURNVALUE_TRADEPLAYERHIGHESTBIDDER:
			return "O jogador com quem deseja negociar � o maior licitante de uma casa em leil�o.";
		...
		case RETURNVALUE_ONLYCRYSTALRINGHERE:
			return "Voc� s� pode equipar um Anel de Cristal aqui.";
			
		case RETURNVALUE_ONLYMOONRINGHERE:
			return "Voc� s� pode equipar um Anel da Lua aqui.";
			
		case RETURNVALUE_ONLYPHOENIXAMULETHERE:
			return "Voc� s� pode equipar um Amuleto da F�nix aqui.";
			
		case RETURNVALUE_ONLYPOWERAMULETHERE:
			return "Voc� s� pode equipar um Amuleto do Poder aqui.";

		default:
			return "Desculpe, n�o foi poss�vel.";
	}
}

int64_t OTSYS_TIME()
{
	// steady_clock is monotonic — never goes backward, unlike system_clock which
	// can jump when WSL2/VM syncs the clock with the host, causing walk freezes.
