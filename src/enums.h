...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_CRITICALHITCHANCE = 1 << 26,
	ITEM_ATTRIBUTE_MAGICLEVEL = 1 << 27,  // Novo atributo para Magic Level
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SKILL_PESCA = 48,
	CONDITION_PARAM_SKILL_PESCAPERCENT = 49,
};
...
enum ReturnValue {
	...
	RETURNVALUE_ONLYCRYSTALRINGHERE,
	RETURNVALUE_ONLYMOONRINGHERE,
	RETURNVALUE_ONLYPHOENIXAMULETHERE,
	RETURNVALUE_ONLYPOWERAMULETHERE,
};
...
struct Outfit_t {
	...
	uint16_t lookAura = 0;
	uint16_t healthBackground = 0;
	uint16_t manaBackground = 0;
	uint16_t koteElemental = 0;
	uint8_t lookHead = 0;
	uint8_t lookBody = 0;
	uint8_t lookLegs = 0;
	uint8_t lookFeet = 0;
...
struct MarketOfferEx {
	...
	MarketOfferEx(MarketOfferEx&& other) :
		...
		amount(other.amount), counter(other.counter), itemId(other.itemId),
		attributes(other.attributes), attributeLength(other.attributeLength),  // Ajuste aqui
		name(other.name), category(other.category), type(other.type), 
