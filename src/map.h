...
class Map
{
	public:
		...
		static constexpr int32_t maxClientViewportY = 25;
		static constexpr int32_t maxViewportX = maxClientViewportX + 2;
		static constexpr int32_t maxViewportY = maxClientViewportY + 2;
		// tactical: range expandido apenas para eventos broadcast (creature move/magic/distance)
		// não afeta tile data → bandwidth ok
		static constexpr int32_t tacticalRangeX = 25;
		static constexpr int32_t tacticalRangeY = 25;
