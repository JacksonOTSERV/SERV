...
enum AttrTypes_t {
	...
	ATTR_WRAPID = 36,
	ATTR_AUTOOPEN = 37,
	ATTR_CRITICALHITCHANCE = 38,
	ATTR_COUNT = 39, // U16 (10k stackable)
};
...
class ItemAttributes
{
	public:
		...
		void setDuration(int64_t time) {
			setIntAttr(ITEM_ATTRIBUTE_DURATION, std::max<int64_t>(0, time));
		}
	...
	private:
		...
		const static uint32_t intAttributeTypes = ITEM_ATTRIBUTE_ACTIONID | ITEM_ATTRIBUTE_UNIQUEID | ITEM_ATTRIBUTE_DATE
			...
			| ITEM_ATTRIBUTE_FLUIDTYPE | ITEM_ATTRIBUTE_DOORID | ITEM_ATTRIBUTE_DURATION_TIMESTAMP | ITEM_ATTRIBUTE_AUTOOPEN | ITEM_ATTRIBUTE_CRITICALHITCHANCE;
...
class Item : virtual public Thing
{
	public:
		...
		int64_t getInternalDuration() const {
		...
		bool unserializeAttr2(PropStream& propStream);
