...
#define createTask(func) std::make_unique<Task>(func)
#define addDispatcherTask(func) g_dispatcher.addTask(std::make_unique<Task>(func))
#define addTimedDispatcherTask(delay, func) g_dispatcher.addTask(std::make_unique<Task>(delay, func))
